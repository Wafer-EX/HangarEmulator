    ...
    private void addOptionsMenu() {
        ...
        radioResolution128x128.addItemListener(e -> {
            if (radioResolution128x128.isSelected()) {
                HangarGamePanelUtils.fitBufferToNewResolution(HangarMainFrame.getInstance().getHangarGamePanel(), new Dimension(128, 128));
            }
        });
        radioResolution128x160.addItemListener(e -> {
            if (radioResolution128x160.isSelected()) {
                HangarGamePanelUtils.fitBufferToNewResolution(HangarMainFrame.getInstance().getHangarGamePanel(), new Dimension(128, 160));
            }
        });
        radioResolution176x220.addItemListener(e -> {
            if (radioResolution176x220.isSelected()) {
                HangarGamePanelUtils.fitBufferToNewResolution(HangarMainFrame.getInstance().getHangarGamePanel(), new Dimension(176, 220));
            }
        });
        radioResolution240x320.addItemListener(e -> {
            if (radioResolution240x320.isSelected()) {
                HangarGamePanelUtils.fitBufferToNewResolution(HangarMainFrame.getInstance().getHangarGamePanel(), new Dimension(240, 320));
            }
        });
